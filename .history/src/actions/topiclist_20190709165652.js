...
//获取详情
export  function getTopicInfoAction(parms) {
  return async dispatch=>{
    let res = await getJSON(api.gettopicinfo+'/'+parms)
    console.log(res)
    if(res.datasuccess==true){
      console.log(res.success)
      dispatch({type:'getTopicDetail',infoData:res.data})
    }
  }
}